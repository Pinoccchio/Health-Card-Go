...
export default function SuperAdminAppointmentsPage() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [dateFilter, filter, searchQuery, serviceFilter]);
  ...
  const fetchAppointments = async () => {
    ...
    try {
      ...
      console.log('📊 [SUPER ADMIN APPOINTMENTS] API Response:', {
      ...
      console.error('❌ [SUPER ADMIN APPOINTMENTS] Fetch error:', err);
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `super_admin_appointments_${serviceFilter}_${dateFilter}_${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
  };

  // Define table columns with Service column added
  const tableColumns = [
    {
      header: 'Queue #',
  ...
  return (
    <DashboardLayout
      ...
      pageDescription="View and manage all appointments across all categories"
    >
      <Container size="full">
        {error && (
        ...
        {loading ? (
          ...
          <>
            {/* Service Category Filter - Super Admin Only */}
        ...
        {/* Drawer for Appointment Details - Identical to healthcare-admin but with service info in drawer */}
        {selectedAppointment && (
          <Drawer
            isOpen={isDrawerOpen}
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                {/* Patient Information - Keep healthcare-admin implementation */}
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2 flex items-center">
                ...
                {/* Emergency Contact - Keep healthcare-admin implementation */}
                ...
                {/* Medical Information - Keep healthcare-admin implementation */}
                {(() => {
