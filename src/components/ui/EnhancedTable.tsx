...
export const EnhancedTable: React.FC<EnhancedTableProps> = ({
  ...
  const getSortIcon = (key: string) => {
    ...
    return sortConfig.direction === 'asc' ? (
      <ChevronUp className="w-4 h-4 text-[#20C997]" />
    ) : (
          ...
          {searchable && (
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#20C997] focus:border-transparent transition-all"
              />
            </div>
          )}
          {onExport && (
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        page === currentPage
                          ? 'bg-[#20C997] text-white font-medium'
