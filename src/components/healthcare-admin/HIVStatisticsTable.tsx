...
import { MoreVertical, Edit2, Trash2, MapPin, Shield } from 'lucide-react';

export interface HIVStatistic {
  id: string;
  service_id: number;
  record_date: string;
...
interface HIVStatisticsTableProps {
            ...
            {statistics.map((stat) => (
              <tr key={stat.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                  {stat.appointments_completed.toLocaleString()}
                </td>
